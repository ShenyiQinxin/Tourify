...
import com.tours.twitterStream.listener.TwitterStreamListener;
...
public class TwitterV2StreamHelper {
    ...
    public TwitterV2StreamHelper(TwitterConfig twitterConfig, TwitterStreamListener twitterStreamListener) {
    ...
    void connectStream(String bearerToken) throws IOException, URISyntaxException, JSONException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterConfig.getTwitterV2StreamUrl());
        ...
        if (null != entity) {
            ...
            while (line != null) {
                ...
                if (!line.isEmpty()) {
                    ...
                    if (status != null) {
                        twitterStreamListener.onStatus(status);
                    }
                }
            }
        }
    ...
    private void createRules(String bearerToken, Map<String, String> rules) throws URISyntaxException, IOException {
        ...
        URIBuilder uriBuilder = new URIBuilder(twitterConfig.getTwitterV2RulesBaseUrl());
